          ...
          {[{ mode: "light", icon: "☀️" }, { mode: "system", icon: "💻" }, { mode: "dark", icon: "🌙" }].map(({ mode, icon }) => (
            <button key={mode} title={mode}
              ...
              style={{
                ...
                background: theme === mode ? (isLight ? "rgba(255,255,255,0.9)" : "var(--bg-rim)") : "transparent",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              ...
              <input
                ...
                onBlur={e => { e.target.style.borderColor = isLight ? "#CBD5E1" : "var(--bg-wire)"; e.target.style.boxShadow = "none"; }}
              />
            </div>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{
                    width: "100%", borderRadius: "10px",
                    padding: "10px 40px 10px 14px", fontSize: "0.9rem",
                    background: isLight ? "#F8FAFC" : "var(--bg-hull)",
                    border: `1px solid ${isLight ? "#CBD5E1" : "var(--bg-wire)"}`,
                    color: isLight ? "#0F172A" : "var(--c-light)",
                    outline: "none", transition: "border-color 0.2s, box-shadow 0.2s",
          ...
          <div style={{
            ...
            <p style={{ fontSize: "0.875rem", color: isLight ? "#64748B" : "#637898", marginBottom: "0.5rem" }}>
              No account?{" "}
              <span
                onClick={() => navigate("/register")}
                style={{ color: isLight ? "#D97706" : "#F59E0B", cursor: "pointer", fontWeight: 600 }}
              >Create one →</span>
            </p>
